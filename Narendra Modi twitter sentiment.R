...
# Set API Keys
api_key <- "XjyXrCI8hgnvC3b6qbDbLeUYr"
api_secret <- "y8zf4iadjQbNlXiUh6HrwJtH9UMXQsIuiiNavyJeWpTouCpFaG"
access_token <- "774697724511940609-mduOodwgHkT9vkW7BprrGiqHnI7Xc0p"
access_token_secret <- "3Ir1UcxoZNbMMt5HlGW3s1zsP0o1xT76WStqeDgxm6jA2"
